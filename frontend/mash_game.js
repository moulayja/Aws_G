...
function message_listener(event) {
	...
	if (key_press_counter.textContent >= 0 && key_press_counter.textContent < 15) {
		message_rank.textContent = "SUPER BABY FINGERS"
	} else if (key_press_counter.textContent >= 15 && key_press_counter.textContent < 20) {
		message_rank.textContent = "SLOW HANDS McOLD PERSON"
	} else if (key_press_counter.textContent >= 20 && key_press_counter.textContent < 35) {
		message_rank.textContent = "CEMENT WRISTS"
	} else if (key_press_counter.textContent >= 35 && key_press_counter.textContent < 40) {
		message_rank.textContent = "BIG MEATY CLAWS"
	} else if (key_press_counter.textContent >= 40 && key_press_counter.textContent < 65) {
		message_rank.textContent = "HAIRY KNUCKLES"
	} else if (key_press_counter.textContent >= 65 && key_press_counter.textContent < 70) {
		message_rank.textContent = "EDWARD SCISSOR HANDS"
	} else if (key_press_counter.textContent >= 70 && key_press_counter.textContent < 85) {
		message_rank.textContent = "UNTRUSTABLE ALI"
	} else if (key_press_counter.textContent >= 85 && key_press_counter.textContent < 100) {
		message_rank.textContent = "FURIOUS TIGER"
	} else if (key_press_counter.textContent >= 100 && key_press_counter.textContent < 105) {
		message_rank.textContent = "JACKY FENG"
	} else if (key_press_counter.textContent >= 105 && key_press_counter.textContent < 110) {
		message_rank.textContent = "RUSSIAN SPY"
	} else if (key_press_counter.textContent >= 110 && key_press_counter.textContent < 115) {
		message_rank.textContent = "FROG"
	} else if (key_press_counter.textContent >= 115 && key_press_counter.textContent < 300) {
